...
```{r fig.height= 10, fig.width= 10 Volcano Plot1: Log2FCvsPadj}
...
```{r fig.height= 10, fig.width= 10 Volcano Plot2: Log2FCvsPadj}
...
```{r}
sigs1df <- resdf[(resdf$baseMean > 5000) & (abs(resdf$log2FoldChange) > 2) & (resdf$pvalue < 0.05), ]
...
GO_UPReg_Heatplot <- plot(heatplot(GO_UPRegResults, label_format = 200))
